                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action=" {{ Route('updateadmin') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group mb-3">
                                            <input type="text" style="border: solid 1px; width: 250px; margin-top:15px;"
                                        ...
                                        <div class="form-group mb-3">
                                            <input type="text" style="border: solid 1px; width: 250px; margin-top:15px;"
                                                placeholder="Email" id="email_address" class="form-control"
                                                value="{{ auth()->user()->email }}" name="email" required autofocus>
                                            @if ($errors->has('email'))
                                                <span class="text-danger">{{ $errors->first('email') }}</span>
                                            @endif
                                        </div>
                                        <div class="form-group mb-3">
                                            <input type="password" style="border: solid 1px; width: 250px; margin-top:15px;"
                                ...
                                <!-- Hinh anh -->
                                <div class="row mb-3">
                                    <label for="avatar" style="padding-right: 58px;"
                                ...
                                <div class="row">
                                    <div class="col-md-8" style="text-align: right; margin-top: 6px; margin-left:">
                                        <a href="http://127.0.0.1:8000/login"
                                            style="text-align: right; text-decoration: none; font-size: 13px;">Đã có tài
                                            khoản</a>
                                    </div>
                                    <div class="col-md-4">
