        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="dropdown ms-5 d-flex align-items-center">
                    @auth
                        <img src="{{ asset('avatar/' . (auth()->user()->avatar ?? 'default.jpg')) }}" class="user-avatar" alt="avatar">
                        <span class="user-name">{{ auth()->user()->name }}!</span>
                    @else
                        <i class="fas fa-user" style="font-size: 24px; color: rgba(255, 255, 255, 0.6);"></i>
                    @endauth
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="margin-left: 5px;"></a>
                    <ul class="dropdown-menu dropdown-menu-end">
                        @guest
                            <li><a class="dropdown-item" href="{{ route('login.form') }}"><i class="fas fa-sign-in-alt"></i> Đăng nhập</a></li>
                            <li><a class="dropdown-item" href="{{ route('register.form') }}"><i class="fas fa-user-plus"></i> Đăng ký</a></li>
                        @endguest
                        @auth
                            <li><a class="dropdown-item" href="{{ route('users.profile') }}"><i class="fas fa-user-circle"></i> Hồ sơ</a></li>
                            <li><a class="dropdown-item" href="{{ route('giohang.index') }}"><i class="fas fa-shopping-cart"></i> Giỏ Hàng</a></li>
                            <li><a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fas fa-sign-out-alt"></i> Đăng xuất</a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-md-end">
                    <h5>Về chúng tôi</h5>
                    <p>Được thành lập bởi hai người bạn thân, chúng tôi mang đến những sản phẩm công nghệ với giá cả hợp lý.</p>
                </div>
            </div>
        </div>
    </footer>
